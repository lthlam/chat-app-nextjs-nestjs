  ...
  return (
    <div className="flex items-center gap-2 p-2 bg-purple-50 dark:bg-slate-800 rounded-xl border border-purple-200 dark:border-slate-700 animate-in slide-in-from-bottom-2">
      {!audioBlob ? (
        <>
          {isRecording && (
            <button onClick={stopRecording} className="p-2 bg-red-500 text-white rounded-full animate-pulse">
              <Square className="w-4 h-4" />
            </button>
          )}
          {!isRecording && !audioBlob && (
            <button onClick={startRecording} className="p-2 bg-purple-600 text-white rounded-full">
          ...
          <button onClick={onCancel} className="ml-auto p-1 text-gray-400 hover:text-gray-600">
        ...
        <>
          ...
          <button onClick={() => setAudioBlob(null)} className="p-1 text-red-500">
            <Trash2 className="w-4 h-4" />
          </button>
