  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-transparent p-4 dark:bg-slate-950">
      <div className="relative max-w-md w-full space-y-8 bg-white/90 p-8 rounded-3xl border-4 border-white shadow-[0_18px_45px_-20px_rgba(67,24,122,0.45)] dark:bg-slate-900 dark:border-slate-700">
        ...
        <div>
          <h2 className="mt-6 text-center text-3xl font-bold text-gray-900 dark:text-slate-100">Sign in</h2>
        </div>
        ...
        <form onSubmit={handleLogin} className="mt-8 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 rounded-xl text-black placeholder:text-gray-400 bg-white/95 ring-2 ring-blue-200 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500 dark:ring-slate-600 dark:focus:ring-blue-500/60"
